...
*}
            ...
            <div id="description" class="product-fullwidth-content">
                ...
                <div class="pfc-cont product-description" itemprop="description">
                    <h2><img src="{$urls.theme_assets}svg/file-green.svg" alt="" />{l s='Description' d='Shop.Theme.Catalog'}</h2>
                ...
                <div class="pfc-cont product-details">
                    <h2><img src="{$urls.theme_assets}svg/info-green.svg" alt="" />{l s='Product Details' d='Shop.Theme.Catalog' }</h2>
                    {include file='catalog/_partials/product-details.tpl'}
                </div>
                {/block}
